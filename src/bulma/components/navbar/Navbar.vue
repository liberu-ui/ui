    ...
    <core-navbar>
      ...
      >
        <div class="navbar-brand">
          <a class="navbar-item" @click="toggleSidebar(isTouch)">
            <span class="icon">
              <fa
                icon="bars"
          ...
          <a class="navbar-item logo" href="#">
            <figure class="image is-32x32 is-flex"></figure>
            <h4 class="title is-4 ml-1" v-if="!isMobile">
              {{ meta.appName }}
            </h4>
          </a>
          <div class="navbar-item" v-if="meta.env !== 'production'">
            <span class="tag is-warning is-clickable" v-tooltip="meta.env">
              <span class="icon is-small">
                <fa icon="code" />
              </span>
            </span>
          </div>
          <div class="navbar-item" v-if="impersonating">
            <a
              v-tooltip="i18n('Stop Impersonating')"
